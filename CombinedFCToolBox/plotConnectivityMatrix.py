...
def plotConnectivityMatrix(ConnMat,
    ...
    #axes ticks labels
    plt.xticks([1,180,360])
    plt.yticks([1,180,360])
    ...
    #make extra adjustment to the position of the matrix labels if networks colorbars are used
    if networkColorBar_x == True:
